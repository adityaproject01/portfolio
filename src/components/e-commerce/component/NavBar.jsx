        ...
        <header className="bg-white shadow-sm sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    {/* Logo */}
                    <div onClick={()=>navigate("/ecommerce/home")}  className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        {/* Cart */}
                        <button onClick={()=>navigate("ecommerce/home/cart")} className="text-gray-600 hover:text-blue-600 transition relative">
                                ...
                                tokens ? (open && (
                                    <div className="absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg z-50">
                                        <ul className="py-2 text-sm text-gray-700">
                                            ...
                                            <li onClick={()=>navigate("/ecommerce/ecommerce/home/order-history")} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">OrderHistory</li>
                                    ...
                                    open && (
                                        <div className="absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg z-50">
                                            <ul className="py-2 text-sm text-gray-700">
                                                <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => { navigate("/ecommerce/ecommerce/login") }}>Login</li>
                                            </ul>
                                        </div>
                                    )
                                )
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-white border-t px-4 py-3 space-y-3">
                    <p onClick={()=>navigate("/ecommerce/home")} className="block text-gray-700 font-medium">Home</p>
